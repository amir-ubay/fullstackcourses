describe('Blog App', () => {
  ...
  context('Exercise 5.19 - When Login', () => {
    ...
    it('A blog can be created', () => {
      ...
      cy.get('.blogItem').contains('Your blog title')
        .should('be.visible')

      cy.get('.blogItem').contains('Your blog author')
        .should('be.visible')
    })
  ...
  context('Exercise 5.23 - Blog Sort', () => {
    ...
    it('Blogs are ordered by likes', () => {
        ...
        cy.get('.blogItem')
          .eq(0)
          .should('contain', 'Alpha blog')

        cy.get('.blogItem')
          .eq(1)
          .should('contain', 'Beta blog')
